  ...
  return (
    <div className="flex items-center justify-center">
      <div style={{ transform: "none" }}>
        ...
        <button
          onClick={onClick}
          className="relative inline-block p-px font-semibold leading-6 text-white no-underline bg-secondary-dark shadow-2xl cursor-pointer group rounded-xl shadow-zinc-900"
        >
